...
Backend работает только с MySQL. Встроенный файловый режим хранения удалён.

В коде больше нет автоматического создания таблиц и автозаполнения базы демо-данными.

Таблицы и демо-данные создаются отдельно через SQL-скрипт.

## Подготовка MySQL

Запусти MySQL Server и выполни:
